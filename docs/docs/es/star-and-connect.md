## Marcar con Estrella el Repositorio del Taller

Marca con estrella el repositorio de GitHub para que puedas encontrarlo fácilmente más tarde.

1. Visita el repositorio: [Desbloquea el Potencial de tu Agente con Protocolo de Contexto de Modelo](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol){:target="_blank"}
